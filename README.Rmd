---
title: "Exploring US Births Data"
...
## What month sees the start of most pregnancies? - look at overall and yearly patterns
...
#brewer.pal.info
median_colours <- brewer.pal(4, "Dark2")   # for median lines
```
...
ggplot(monthly_births, aes(month_lab, total_births)) +
     ...
     geom_hline(aes(yintercept=median(total_births)), colour=median_colours[2]) +   # median line
...
ggplot(avg_monthly_births, aes(month_lab, total_births)) +
     ...
     geom_hline(aes(yintercept=avg_monthly_median), colour=median_colours[1]) +   # median line
...
ggplot(avg_monthly_births_2, aes(month, total_births, fill=source)) +
     ...
     geom_hline(aes(yintercept=avg_monthly_median), colour=median_colours[4]) +   # median line
...
ggplot(births_intersection, aes(source, births, fill=source)) +
     ...
     guides(fill=FALSE) +
     scale_fill_manual(values = median_colours[3:4]) +
